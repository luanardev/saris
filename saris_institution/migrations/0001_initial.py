    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_address', models.EmailField(blank=True, max_length=255, null=True)),
                ('telephone_one', models.CharField(blank=True, max_length=100, null=True)),
                ('telephone_two', models.CharField(blank=True, max_length=100, null=True)),
                ('logo', models.ImageField(blank=True, max_length=255, null=True, upload_to='saris_institution/logo')),
                ('favicon', models.ImageField(blank=True, max_length=255, null=True, upload_to='saris_institution/logo')),
