# Generated by Django 5.0.2 on 2024-03-12 11:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_number', models.IntegerField(blank=True, editable=False, null=True, unique=True)),
                ('title', models.CharField(choices=[('Miss', 'Miss'), ('Mr', 'Mr'), ('Mrs', 'Mrs'), ('Dr', 'Dr'), ('Prof', 'Prof')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(max_length=255)),
                ('middle_name', models.CharField(blank=True, max_length=255, null=True)),
                ('relationship', models.CharField(choices=[('Father', 'Father'), ('Mother', 'Mother'), ('Son', 'Son'), ('Daughter', 'Daughter'), ('Husband', 'Husband'), ('Wife', 'Wife'), ('Brother', 'Brother'), ('Sister', 'Sister'), ('Uncle', 'Uncle'), ('Aunt', 'Aunt'), ('Nephew', 'Nephew'), ('Niece', 'Niece'), ('Grandfather', 'Grandfather'), ('Grandmother', 'Grandmother')], max_length=255)),
                ('occupation', models.CharField(blank=True, max_length=255, null=True)),
                ('organization', models.CharField(blank=True, max_length=255, null=True)),
                ('email_address', models.CharField(max_length=255)),
                ('postal_address', models.CharField(max_length=255)),
                ('phone_number', models.CharField(max_length=255)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='saris_students.student')),
            ],
            options={
